...
public class GetOrderController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<OrderDTO> result = bean.showOrder();
            request.setAttribute("INFO", result);
        } catch (Exception e) {
            log("Error at GetOrderCOntroller : " + e.getMessage());
        } finally{
            request.getRequestDispatcher("admin/get_order.jsp").forward(request, response);
        }
    }
